                        ...
                        <form action='{{ route('modelos.store') }}' method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-3">
                                  <!-- Portas input-->
                                    <div class="form-floating mb-3">
                                        <input type="number" class="form-control" id="numero_portas" name="numero_portas" min="1" max="5" placeholder="Enter your name...">
                                ...
                                <div class="col-12 col-md-3">
                                  <!-- Lugares input-->
                                    <div class="form-floating mb-3">
                                        <input type="number" class="form-control" id="lugares" name="lugares" min="1" max="10" placeholder="Enter your name...">
                                ...
                                <div class="col-6 col-md-3">
                                  <!-- Air Bag input-->
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" name="air_bag" type="checkbox" role="switch" id="flexSwitchCheckDefault">
                                ...
                                <div class="col-6 col-md-3">
                                  <!-- ABS input-->
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" name="abs" type="checkbox" role="switch" id="flexSwitchCheckDefault2">
